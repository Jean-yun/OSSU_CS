...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname P1_Alt_tuition_graph) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
