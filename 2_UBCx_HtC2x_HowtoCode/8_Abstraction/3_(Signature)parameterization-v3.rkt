...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |3_(Signature)parameterization-v3|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (map2 string-length (list "a" "bc" "cdfsg")) (list 1 2 5))
