...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Q1_design_quiz) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#lang htdp/isl
(require 2htdp/image)
